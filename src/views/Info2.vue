<template>
    <div>
                ...
                <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
                    <div class="pt-32 sm:pt-0">
                        <h2 class="font-semibold text-4xl text-blueGray-600">
                            LƯỢC SỬ GIÁO HỌ NHÀ XỨ ĐẠI TỪ </h2>
        ...
        <div class="container mx-auto px-4">
            <div class="items-center flex flex-wrap">
                ...
                <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
                    <div class="md:pr-12">
                        <h3 class="text-3xl font-semibold">Đến khoảng năm 1920</h3>
                        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                            Có một vị linh mục vì muốn quy tụ
        ...
        <section class="mt-48 md:mt-40 pb-20 relative ">
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full md:w-6/12 px-4">
                                <div class="relative flex flex-col mt-4">
                                    <div class="px-4 py-5 flex-auto">
                                        <h6 class="text-xl mb-1 font-semibold">
                                            Năm 1942 Cha Xuân về quản xứ,
                                        </h6>
                                        <p class="mb-4 text-blueGray-500">
                                            Ngài đã chuẩn bị vật liệu
                                ...
                                <div class="relative flex flex-col min-w-0">
                                    <div class="px-4 py-5 flex-auto">
                                        <h6 class="text-xl mb-1 font-semibold">
                                            Năm 1945 - 1947 cha Ngọc về quản xứ
                                        </h6>
                                        <p class="mb-4 text-blueGray-500">
                            ...
                            <div class="w-full md:w-6/12 px-4">
                                <div class="relative flex flex-col min-w-0 mt-4">
                                    <div class="px-4 py-5 flex-auto">
                                        <h6 class="text-xl mb-1 font-semibold">Năm 1947 - 1950</h6>
                                        <p class="mb-4 text-blueGray-500">
                                            Cha Phước về quản xứ.
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto mt-48">
                    <h3 class="text-3xl mb-2 font-semibold leading-normal">
                        Đến cuối năm 1994 - 1998
                    </h3>
                    <p
                            class="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600"
                    >
                        Cha Đaminh Nguyễn Văn Kinh về quản nhiệm.
                        <br>
                        <br>
                    ...
                    <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                        <div class="pr-12">
                            ...
                            <p class="mt-4 text-lg text-blueGray-200">
                                Đức Cha Cosma Hoàng Văn Đạt đã lên cắt băng khánh
        ...
        <div class="justify-center text-center flex flex-wrap mt-24">
            <div class="w-full md:w-6/12 px-12 md:px-4">
                ...
                <p class="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500">
                    ...
                    <br>
                    Từ 12/7/2019 – 2022, Cha Giuse Lê Thành Văn chính xứ
                    <br>
                    Từ 09/07/2022 - nay, Cha Giuse Đinh Văn Thành chính xứ
                </p>
            </div>
        </div>
